...
{   
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            socket = new ReliableDatagramSocket(CLIENT_PORT_NUMBER);
        ...
        {          
            ...
            {                
                ...
                socket.send(new DatagramPacket(readBytes, readBytes.length, serverAddress, serverPortNumber));
            ...
            socket.send(new DatagramPacket(new byte[0], 0, serverAddress, serverPortNumber));
            
            // This line is commented out because it caused exceptions in 
            //socket.close();
